														...
														<div class="single-tab-select-box">
															...
															<div class="travel-select-icon">
																<select class="form-control " name="from_loc" required>
																	...
																	<option value="">enter your origin location</option><!-- /.option-->
															...
															<div class="travel-select-icon">
																<select class="form-control " name="destination_loc" required>
												...
												<div class="row">
																...
																<div class="col-sm-9">
																	<div class="travel-filter-container">
																		<div class="travel-filter">
																			<label for="start_budget">Min</label>
																			<div class="money_input">
																				<span>RM</span>
																				<input type="number" name="min_budget" class="form-control" min="0" step="0.01"  placeholder="RM 300">
																			</div>
																		</div><!--/.travel-filter-->
																		<div class="travel-filter">
																			...
																			<div class="money_input">
																				<span>RM</span>
																				<input type="number" name="max_budget" class="form-control" min="0" step="0.01"  placeholder="RM 300">
																			</div>
																		</div>
																	</div><!--/.travel-filter-->
																</div><!--/.col-->
													...
													<div class="clo-sm-7">
														<div class="about-btn travel-mrt-0 pull-right">
															<button type="submit" form="travel-form" class="about-view travel-btn">
																search	
															</button><!--/.travel-btn-->
														</div><!--/.about-btn-->
													</div><!--/.col-->
								...
								<?php if (!empty($articles)): ?>
									<?php foreach ($articles as $article): ?>
										<div class="col-sm-4 col-md-4">
											<div class="thumbnail">
												<h2>Trending News <span><?php echo date("d F Y", strtotime($article['publishedAt'])); ?></span></h2>
